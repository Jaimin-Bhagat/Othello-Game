...
public class OthelloApplication extends Application {
	...
	private static CurrentTokenView currTokenView;
	Othello othello;
	...
	public void start(Stage stage) throws Exception {
		...
		while (!validInputs) {
			try {
				...
				dialog.setHeaderText("Check the input and try again!\n" +
						"Please enter the time for each player:");
				dialog.showAndWait();
			}
		}
		...
		VBox newTleft = gametimer.getGUI();
		...
		//setting on the pane
		     ...
		     // setting the buttons to change the players mid-game.
				...
				currTokenView = new CurrentTokenView(returnOthello(), cplayer, currentState);
				FlipView flipAnimation = new FlipView(othello, buttons, OthelloApplication.whosPlayer1.getText(),
